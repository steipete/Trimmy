...
## 0.10.2 — Unreleased
- Text reflow now recognizes hard-wrapped plain prose, optionally runs automatically during Auto-Trim, avoids structured configuration, removes leading blank lines when configured, and preserves internal paragraph breaks, headings, lists, and fenced code.
...
- Aggressiveness now splits between general apps and terminals (defaults: Low + Normal), plus a “None” option to disable auto-trim in regular apps.
