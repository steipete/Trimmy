...
const productName = "Trimmy";
const productDescription = "Trimmy flattens copied multi-line shell snippets so they paste and run cleanly.";
const source = "https://github.com/steipete/Trimmy";
